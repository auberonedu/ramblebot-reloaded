...
public class WordPredictor {
     ...
     *
     * Checks that the map is not empty. For each entry, verifies the list is not
     * null or empty,
    ...
    public String predict(String word) {
        ...
        if (list == null || list.isEmpty()) {
            throw new IllegalArgumentException("No probabilities found for word: " + word);
        }
        // random in [0.0, 1.0)
        ...
        while (low < high) {
            ...
            if (list.get(mid).cumulativeProbability() >= r) {
